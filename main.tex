...
The algorithm is related to the well-known Hironaka's polyhedra game and 
can be used to similar problems, \textit{e.g.} sector decomposition.
\end{abstract}
\newpage
...
An winning strategy for $\mathcal{P}_{1}$ will tell us how to blow up the polynomial $p$ and hence calculate stringy integrals. There're many known winning strategies \cite{spivakovsky1983solution,zeillinger2006short,hauser2003hironaka}.
...
positive rational number $c$, and the algorithm tells us how to calculate 
the leading order of stringy integrals more efficiently.
...
The algorithm introduced in section \ref{s:alg} is,  in a sense, the byproduct of the geometric viewpoint, and there is still much room to improve. Some possible improvements could happen in the procedure (3) of the algorithm. 
...
Although the situation here is easier than the Feynman diagram calculation due to the agreeable property of canonical forms and the extra rescaling operation, we expect that this kind of geometric view point will give some insights of the calculation of Feynman diagrams in which some efforts have been made (see \cite{Kaneko:2009qx}). On the other hand, Another objects for Feynman diagrams, Hepp's bound, are recently found to have a closed relation to the polytope geometry~\cite{Panzer:2019yxl}. It would be facinating to explore further relations between the leading order contribution of the stringy canonical forms and Feynman diagrams from this geometric viewpoint.
