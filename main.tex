...
\begin{enumerate}
	...
	\item In the viewpoint of cones in the space of row vectors, 
	the blowing up is nearly a subdivision of the cone.
	...
	and the new vector $\sum_{i\in S} c_i n_i$. They divides the original cone. For example,
	\begin{center}
	\begin{tikzpicture}
	\draw (1.7,2.6) -- (-2,-0.5);
	\draw (-2,-0.5) -- (3.5,-0.5);
	...
	However, if $n_j$ is not the vector of a edge of the cone, every 
\end{enumerate}
