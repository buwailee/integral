...
\begin{abstract}
	We provide an efficient method, blowing up, to compute leading order contributions of the recently introduced stringy integrals. The algorithm also gives a new winning strategy of the well-known Kironaka's polyhedra game.
\end{abstract}
\newpage
