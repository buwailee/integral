...
This integral is equivalent to the $Z$-integral $Z(1^{+}2^{+})$ defined on the moduli space of paired punctures~\cite{}, which in a positive parameterization is 
\begin{align*}
...
\begin{pro*}
	...
	\]
	where $\alpha_0$ is a positive number such that $\alpha_0< \alpha_p$ for all $p$, which is a convex function 
