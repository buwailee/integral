...
we can delete some column vectors corresponding to the points in the interior of polyhedron of $p$.
...
\begin{enumerate}
	...
	\item[(1).] Find the minimal cone containing $(1,\dots,1)$, blow up according to
	...
	\item[(2).] For a given matrix, find all edges of its cone, and 
		divide the cone along the other vectors in the cone by blowing up.
