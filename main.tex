...
\begin{enumerate}
	...
	in the modified integral. The new generated matrix for each $i\in S$ is just the matrix
...
is in the cone spanned by row vectors $\{n_i^I\,:\,i\in S\}$. However, $(1,\dots,1)$ is usually not
in this cone.
