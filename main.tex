...
\begin{equation}\label{int1}
	\int_{\mathbb R_+^D}\prod_{i=1}^D\frac{\dif x_i}{x_i}\prod_{a} p_a^{-\alpha' c_a}
	\quad\text{or}\quad
	\int_{[0,1]^D}\prod_{i=1}^D\frac{\dif x_i}{x_i(1-x_i)}\prod_{a} q_a^{-\alpha' c_a},
\end{equation}
...
Let's show a glance what we have done 
