...
\[
	I=\int_{\mathbb R_1+^2} \frac{dx}{x}\frac{dy}{y}x^{\alpha' a}y^{\alpha' b}(1+x+y)^{-\alpha' c}.
\]
...
\[
	I(0,\infty)=\int_{0}^\epsilon\int_{1/\epsilon}^\infty \frac{dx}{x}\frac{dy}{y}x^{\alpha' a}y^{\alpha' b}(1+x+y)^{-\alpha' c}\sim \int_{0}^\epsilon\int_{1/\epsilon}^\infty \frac{dx}{x}\frac{dy}{y}x^{\alpha' a}y^{\alpha' (b-c)}\sim 
...
\[
	I(\infty,\infty)=\int_{1/\epsilon}^\infty \int_{1/\epsilon}^\infty \frac{dx}{x}\frac{dy}{y}x^{\alpha' a}y^{\alpha' b}(1+x+y)^{-\alpha' c}
=\int_{1/\epsilon}^\infty \int_{1/\epsilon}^\infty \frac{dx}{x}\frac{dy}{y}x^{\alpha' a}y^{\alpha' b}(x+y)^{-\alpha' c}.
\]
When $(x,y)\to (\infty,\infty)$, we cannot decouple $x$ and $y$ in the mixed factor $(x+y)^{-\alpha' c}$ because we don't know which one is dominated. A clever way to calculate it is blowing-up. Let $x = tp$ and $y=t(1-p)$, then
